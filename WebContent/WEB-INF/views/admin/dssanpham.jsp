                ...
                <div class="grid">
                    <div class="grid--row">
                        ...
                        <div class="grid--column-2-5">
                            <h3 class="cart--list--header">XUẤT XỨ</h3>
                        ...
                        <div class="grid--column-2-5-1">
                            <h3 class="cart--list--header">GIẢM GIÁ</h3>
                    ...
                    <c:forEach var = "s" items = "${sanphams }" varStatus = "status">
                    <div class="grid--row grid--row1">
                        <div class="grid--column-2-5-1 cart--list--contain">
                            <img src="${s.getLink() }" alt="" class="cart--list-img">
                        </div>
                        <div class="grid--column-2-5-2 cart--list--contain">
                            <span class="cart--list--contain-label">${s.getTen() }</span>
                            
                        </div>
                        <div class="grid--column-2-5 cart--list--contain">
                            <span class="cart--list--contain-label">${s.getXuatXu() }</span>
                        ...
                        <div class="grid--column-2-5-1 cart--list--contain">
                            <span class="cart--list--contain-label">${s.getGiamGia() }%</span>
                        </div>
    
                        <div class="grid--column-2-5 cart--list--contain">
                            <button class="cart--list--contain-label">
                            <a class = "cart--list--contain-link" href="admin/sanpham/sua/${s.getId().trim() }.htm">Sửa</a>
                            </button>
                            <button class="cart--list--contain-label">
                            <a class = "cart--list--contain-link" href="admin/sanpham/xoa/${s.getId().trim() }.htm">Xóa</a>
                            </button>
                        </div>
                    </div>
                    </c:forEach>
