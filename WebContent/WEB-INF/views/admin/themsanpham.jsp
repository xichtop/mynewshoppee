...
<body>
	...
	<!-- Form đăng kí -->
            <!-- <div class="form"> -->
            <form:form class="form" action = "admin/themsanpham.htm" modelAttribute="sanpham">
                <div class="form--container">
                    <div class="form--header">
                        <h3 class="form--header-heading">Thêm Sản Phẩm Mới</h3>
                    </div>
                    <div class="form--body">
                    	<span style="color: red; font-style: italic;">${message}</span>
                        <div class="form--body-group">
                            <form:input path = "Id" type="text" class="form--body-input1" placeholder="ID sản phẩm"/>
                            <form:errors style="color: red; font-style: italic; padding-top: 10px;" path="Id"></form:errors>
                        </div>
                        <div class="form--body-group">
                        ...
                        <div class = "form--body-gender" style = "padding-top: 10px; font-size: 1.6rem;" class = "form--body-gender">
