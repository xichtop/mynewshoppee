        ...
        <div class="app-container">
            <div class="grid">
				<div class="grid--row">
					...
					<div class="grid--column-2-5">
						<h3 class="cart--list--header">NGÀY MUA</h3>
					</div>
                </div>
                <c:forEach var = "ctgh" items = "${sortedMaps }" varStatus = "status">
                <div class="grid--row grid--row1">
					...
					<div class="grid--column-2-5 cart--list--contain">
						<span class="cart--list--contain-label">
						<fmt:formatDate value="${ctgh.getValue().getNgayMua() }" pattern="dd-MM-yyyy" />
						</span>
					</div>
                </div>
                </c:forEach>
                <div class="grid--row">
					...
					<div class="grid--column-2-5 cart--list--contain--info">
						...
						<fmt:formatNumber value="${tongtienls }" type="currency" pattern = "###,###,### đ"/>
						</h3>
					</div>
                </div>
			</div>
